<template>
  <div class="main-login w-full h-full flex items-center justify-center relative">
    ...
    <div class="w-full">
      ...
      <form @submit.prevent="onSubmit" class="mt-8 w-3/4 mx-auto">
        ...
        <input class="no-highlight-color cursor-pointer w-full mt-16 block py-3 px-3 rounded-full bg-lunchPink-600 text-lunchPurple-700 text-center font-black uppercase text-lg focus:bg-lunchPink-700 hover:bg-lunchPink-700" type="submit" name="submit" value="CONNECT">
      </form>
      <div class="w-full text-center">
        <router-link to="/register" class="mt-6 text-white font-bold text-sm inline-block">Or Sign Up</router-link>
      </div>
    </div>
  </div>
</template>
