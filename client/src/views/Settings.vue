<template>
  <div class="android main-settings w-full h-full">
    ...
    <div v-if="validParams" class="android dashboard w-5/6 mx-auto mt-6" style="height:85%;">
      <div class="' border border-lunchPink-600 bg-lunchPurple-800 rounded-lunch h-full w-full'">
        ...
        <div class="wrapper flex flex-col justify-between w-full" style="height:88%;">
          ...
          <div class="buttons-section mt-4">
            ...
            <div class="cursor-pointer no-highlight-color flex justify-center w-17/20 mx-auto mt-4 block py-3 px-3 rounded-full bg-lunchPurple-900 text-center font-black uppercase text-lg focus:outline-none">
