<template>
  <div class="mt-4 expenseTab border border-lunchPink-600 rounded-lunch" style="height:calc(100% - 194px);">
    <div @click="openModalAdd = true" class="cursor-pointer no-highlight-color flex justify-center w-17/20 mx-auto mt-5 block py-3 px-3 rounded-full bg-lunchPurple-900 text-center font-black uppercase text-lg focus:outline-none">
