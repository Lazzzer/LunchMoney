      ...
      <div class="w-5/6 bg-lunchPurple-800 rounded-lunch border border-lunchPink-600 z-10 h-48" style="max-width:600px;">
        <div v-if="budgetDeleted" class="flex items-center w-full h-full">
          <div class="w-full">
            ...
            <div @click="goToDashboard" class="no-highlight-color cursor-pointer w-3/5 mx-auto mt-4 block py-3 px-3 rounded-full bg-lunchPink-600 text-lunchPurple-700 text-center font-black uppercase text-lg focus:outline-none">EXIT</div>
          </div>
        </div>
        <div v-else>
