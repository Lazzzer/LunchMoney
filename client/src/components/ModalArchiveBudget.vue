    ...
    <div class="modal-new-budget w-screen h-screen absolute top-0 left-0 flex items-center justify-center">    
      ...
      <div class="w-5/6 bg-lunchPurple-800 rounded-lunch border border-lunchPink-600 z-10 h-48" style="max-width:600px;">
        ...
        <div v-else>
          ...
          <div class="flex">
            <div @click="archiveBudget" class="w-1/2 ml-4 mr-2  mt-4 block py-3 px-3 rounded-full bg-lunchPink-600 text-lunchPurple-700 text-center font-black uppercase text-lg focus:outline-none focus:bg-lunchPink-700 hover:bg-lunchPink-700">YES</div>
