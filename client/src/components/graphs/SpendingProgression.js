...
export default {
  ...
  methods: {
    prepareData() {
      ...
      this.progression.push(...this.spendingProgression.map(period => period.progression))
      ...
      if (today.getDate() === lastDate.getDate()) {
        ...
        this.arrayProjection = [0, this.arraySpendings[1], this.arraySpendings[2], Math.ceil((this.arraySpendings[3] + this.progression[2] + this.progression[1] / 3))]
